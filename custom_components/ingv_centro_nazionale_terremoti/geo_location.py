...
def setup_platform(hass, config, add_entities, discovery_info=None):
    ...
    feed = IngvCentroNazionaleTerremotiFeedEntityManager(
...
class IngvCentroNazionaleTerremotiFeedEntityManager:
    """Feed Entity Manager for INGV Centro Nazionale Terremoti GeoRSS feed."""
    ...
    def _generate_entity(self, external_id):
        """Generate new entity."""
        new_entity = IngvCentroNazionaleTerremotiLocationEvent(self, external_id)
...
class IngvCentroNazionaleTerremotiLocationEvent(GeolocationEvent):
    ...
    def should_poll(self):
        """No polling needed for INGV Centro Nazionale Terremoti feed location events."""
        return False
